 ...
 * DISCLAIMER
 * -------------------------------------------------------------------------------------
 * This is an PHP OO solution to validate Brazilian CPF
 * based on http://www.geradorcpf.com/script-validar-cpf-php.htm
 *
 * Thanks to http://www.geradorcpf.com/ Team to share your solution
 */

namespace Vsilva472\phpCPF;
